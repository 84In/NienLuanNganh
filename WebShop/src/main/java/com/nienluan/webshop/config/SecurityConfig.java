...
public class SecurityConfig {
    ...
    private final String[] PUBLIC_POST_METHOD_ENDPOINTS = {"/api/v1/users", "/api/v1/users/admin", "/api/v1/auth/login", "/api/v1/auth/logout"};
    private final String[] PUBLIC_GET_METHOD_ENDPOINTS = {"/images", "/images/**", "/api/v1/categories", "/api/v1/promotions", "/api/v1/promotions/**", "/api/v1/search/", "/api/v1/search/**", "/api/v1/products", "/api/v1/products/**", "/api/v1/brands/**", "/api/v1/banners/**", "/api/v1/orders/vnpay-callback", "/api/v1/orders/zalopay-callback"};
