  ...
  return (
    <div>
      ...
      <div className="flex flex-col gap-2 bg-gray-200 p-2">
        <div className="rounded-md bg-white p-2 text-2xl font-semibold underline-offset-1">Quản lý mã giảm giá</div>
        <div className="rounded-md bg-white">
          <div className="flex h-10 items-center rounded-tl-md rounded-tr-md bg-gray-100">
            ...
            <NavLink to={path.ADMIN_PROMOTION_CREATE} className={({ isActive }) => (isActive ? active : nonActive)}>
              Thêm mã giảm giá
            </NavLink>
          </div>
